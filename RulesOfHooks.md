...
Team React release một plugin ESLint là 'eslint-plugin-react-hooks' để đảm bảo chúng ta theo 2 rule.
Chúng ta nên dùng để hạn chế những bug không đáng có trong tương lai.
